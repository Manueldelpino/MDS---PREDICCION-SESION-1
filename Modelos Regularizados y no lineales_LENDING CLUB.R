setwd("C:/Users/Knowhow/Desktop/CUNEF/PREDICCION/LENDING CLUB TAREA 3 PREDICCION")


###LENDING CLUB (HW2 A MEJORAR)### - Modelos de Regularización ~ Modelos no Lineales
...
loan.Q4 <- read.csv("C:/Users/Knowhow/Desktop/CUNEF/PREDICCION/LENDING CLUB TAREA 3 PREDICCION/LoanStats_2016Q4.csv",skip=1,na.strings=c("","n/a"))
...
#Aquí crea un dataframe nuevo para agrupar aquellas filas que contengan mas del 10% de NA para luego eliminarlas
