setwd("C:/Users/Knowhow/Desktop/CUNEF/MDS-PREDICCION/TAREA 2 PREDICCION LENDING CLUB")
...
#Escogemos loan_status como variable dependiente, dejando un total de 18 variables independientes las cuales considero son significativas para explicar "loan_status"
